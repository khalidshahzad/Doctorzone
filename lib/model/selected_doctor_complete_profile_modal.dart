class SelectedDoctorProfileModel {
  String id;
  String uID;
  ...
  SelectedDoctorProfileModel(
      ...
      this.mem_city,
      // ignore: non_constant_identifier_names
      this.mem_description,
      // ignore: non_constant_identifier_names
      this.mem_endingDate,
      // ignore: non_constant_identifier_names
      this.mem_startingDate,
      // ignore: non_constant_identifier_names
      this.mem_institute,
      this.awarduID});

  factory SelectedDoctorProfileModel.fromjason(Map<String, dynamic> json) {
    return SelectedDoctorProfileModel(
      id: json["personalData"] as String,
      ...
      mem_uID: json['mem_uID'] as String,
      mem_country: json['mem_country'] as String,
      mem_city: json['mem_city'] as String,
      mem_endingDate: json['mem_endingDate'] as String,
      mem_institute: json['mem_institute'] as String,
      mem_startingDate: json['mem_startingDate'] as String,
